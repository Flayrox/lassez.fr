Set up the MCP server from https://github.com/supabase-community/supabase-mcp while adhering to these MCP server installation rules:
- Start by loading the MCP documentation.
- Use "github.com/supabase-community/supabase-mcp" as the server name in cline_mcp_settings.json.
