            ...
            {ENABLE_FINANCIAL_SUPPORT ? (
                ...
                <section className="grid md:grid-cols-2 gap-12 px-4 relative z-10">
                    ...
                    <div className="flex flex-col gap-6">
                        <a href="https://twitter.com/lassezmedia" target="_blank" rel="noopener noreferrer" className="group bg-paper-bright border-4 border-black p-6 shadow-hard hover:shadow-hard-xl hover:-translate-y-1 transition-all flex items-center justify-between">
                        ...
                        <a href="https://bsky.app/profile/lassez.fr" target="_blank" rel="noopener noreferrer" className="group bg-paper-bright border-4 border-black p-6 shadow-hard hover:shadow-hard-xl hover:-translate-y-1 transition-all flex items-center justify-between">
                        ...
                        <a href="https://instagram.com/lassezmedia" target="_blank" rel="noopener noreferrer" className="group bg-paper-bright border-4 border-black p-6 shadow-hard hover:shadow-hard-xl hover:-translate-y-1 transition-all flex items-center justify-between">
